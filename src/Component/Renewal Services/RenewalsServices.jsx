          ...
          <div className="card-body">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="top_lift_corner">
                ...
                {/* <Button className='btn btn-primary' onClick={handleSho}>Upload RenewalsServices</Button> */}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-body">
            <label className="bottom_lift_corner">
              <h1>Available RenewalsServices Type List: </h1>
        ...
        <div>
          <Modal show={show} onHide={handleClo}>
            <Modal.Header className="Header_Modal">
              ...
              <Modal.Title>Add New RenewalsServices </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              ...
              <div className="new_location_modal">
                <label>Amount:<a className="asd">*</a>{" "}
                </label>
              </div>
              <div className="new_location_modal">
                <input
...
export default RenewalsServices;

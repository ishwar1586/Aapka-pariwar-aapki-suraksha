...
const  Services = () => {
  ...
  const handleClose = async (e) => {
    ...
    await axios
      .post(`http://13.235.85.235/SafalCr/api/Service/SaveDataService`, lead)
      .then((response) => {
  ...
  const loadUsers = async () => {
    await axios
      .post(`http://13.235.85.235/SafalCr/api/Service/fetchService`, {
        Id: 0,
      })
      .then((response) => {
        setLocation(response.data);
  ...
  const Delete = async (id) => {
    console.log("id", id);
    await axios
      .post(`http://13.235.85.235/SafalCr/api/Service/DeleteService`, {
        Id: id,
      })
      .then((response) => {
        setLocation(response.data);
          ...
          <div className="card-body">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="top_lift_corner">
                ...
                {/* <Button className='btn btn-primary' onClick={handleSho}>Upload  Services</Button> */}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-body">
            <label className="bottom_lift_corner">
              <h1>Available  Services Type List: </h1>
          ...
          <Modal show={show} onHide={handleClo}>
            ...
            <Modal.Body>
              <div className="new_location_modal">
                <label>Service :<a className="asd">*</a>{" "}
                </label>
              </div>
              <div className="new_location_modal">
                <input
